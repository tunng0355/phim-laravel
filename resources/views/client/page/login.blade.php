                    ...
                    <div>
                        <form action="/login" method="POST">
                            ...
                            <div class="form-group text-gray">
                                <label for="" class="fs-13">Tài khoản:</label>
                            ...
                            <button type="submit" class="fs-13 fw-500 mt-3 btn btn-primary w-100 text-uppercase" style="height:2.5rem">Đăng nhập</button> 
                            <span class="d-block text-secondary text-center fs-12 py-2 divider"></span> 
                            <a href="/register" class="text-gray text-center fw-500 d-block fs-14">
                                Bạn chưa có tài khoản? <span class="text-primary">Đăng ký ngay</span>
                            </a>
                        </form>
                    </div>
                </div>
